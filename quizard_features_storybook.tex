...
\begin{titlepage}
    ...
    \begin{tcolorbox}[colback=white,colframe=cardBorder,width=0.95\linewidth,arc=2mm,title=\textbf{\sffamily Core System Pillars Covered}]
        \begin{itemize}\small
            ...
            \item \textbf{XP Ledger \& Daily Streaks:} Consistent daily streak rewards ($+20\text{ XP/day}$) with giant $+500\text{ XP}$ Day 15 surge
...
\input{chapters/chapter08_rank_velocity_personalization_adaptive}
\newpage

\input{chapters/chapter09_cms_fastapi_telemetry_service}
\newpage

\input{chapters/chapter10_cms_admin_multigame_ecosystem}
\newpage

\input{chapters/chapter11_reporting_analytics_payouts}
\newpage

\input{chapters/chapter12_api_architecture_dotnet_migration}
\newpage
