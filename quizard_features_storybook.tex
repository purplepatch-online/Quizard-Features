...
\begin{titlepage}
    ...
    \begin{tcolorbox}[colback=white,colframe=cardBorder,width=0.95\linewidth,arc=2mm,title=\textbf{\sffamily Core System Pillars Covered}]
        \begin{itemize}\small
            ...
            \item \textbf{Authentication \& Logout Lifecycle:} MSISDN regex normalization, carrier billing routing, and token invalidation
        \end{itemize}
    \end{tcolorbox}
...
\input{chapters/chapter7_cms_admin_multigame_ecosystem}
\newpage
...
\input{chapters/chapter10_xp_ledger_linear_streaks_badges}
\newpage

\input{chapters/chapter11_rank_velocity_personalization_adaptive}
\newpage

\input{chapters/chapter12_authentication_identity_lifecycle_logout}
\newpage
